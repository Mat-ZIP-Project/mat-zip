...
public interface PaymentService {
     ...
     *  사전 검증 - 결제창 띄우기 전 호출
     */
    PreparationResDto prepareValid(PreparationReqDto request) throws BasicException, IamportResponseException, IOException;
     ...
     * portOne 결제 취소 함수
     */
//    boolean cancelPayment(String impUid, BigDecimal amount, String reason) throws BasicException;
}
